(function(window, angualr) {
	...
	app.controller('editWxUnionController', [
		'$localStorage',
		'$scope',
		'$location',
		'$log',
		...
		'$http',
		'$state',
		function editWxUnionController($localStorage, $scope, $location, $log, $q, $rootScope, globalParam, $window, routeService, $http, $state) {
			...
			$scope.editId= $localStorage.editData.id;
			$scope.thumb = $localStorage.editData.thumb;
			$scope.qrcode = $localStorage.editData.qrcode;
			$scope.title = $localStorage.editData.title;
			$scope.description = $localStorage.editData.description;
		    ...
		    $scope.addInfo = function(){
            	...
            	$http({
                    method: "post",
					url: $localStorage.wxunionServiceUrl + 'wxUnion/update',
                    params: {
                    	id:$scope.editId,
						title:$scope.title,
